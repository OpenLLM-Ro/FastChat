...
class LlamaFoundationAdapter(BaseModelAdapter):
    """The model adapter for Llama-2 Foundation (e.g., meta-llama/Llama-2-7b-hf)"""

    def match(self, model_path: str):
        return "llama-foundation" in model_path.lower()
